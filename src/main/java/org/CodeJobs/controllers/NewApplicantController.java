...
import org.CodeJobs.models.data.NewApplicantDao;
...
public class NewApplicantController {
    ...
    public String processAdd(Model model , @ModelAttribute @Valid NewApplicant newApplicant, Errors errors, HttpSession session){
        if (errors.hasErrors()) {
