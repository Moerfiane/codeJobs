...
public class JobController {
    ...
    public String processJobAdd(@ModelAttribute @Valid Job newJob, Errors errors, HttpSession session, Model model, HttpServletRequest request, HttpServletResponse response) {
